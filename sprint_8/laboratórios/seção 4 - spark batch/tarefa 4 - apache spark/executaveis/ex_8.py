...
# utilizando sparksql repetindo o processo do ex_6 registrando tambem uma tabela temporaria "pessoas"
...
# utilizando o metodo select do dataframe df_nomes, realizar contagem da quantidade de pessoas que pertencem
